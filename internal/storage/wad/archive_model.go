...
func buildHeader(kind string, lumpCount int64, directoryOffset int64) (domain.Header, error) {
...
func buildLump(name string, offset int64, size int64) (domain.Lump, error) {
